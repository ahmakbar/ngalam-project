...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="img/ngalamsecret-removebg-preview.png" type="image/x-icon">
        <!-- Web Fonts -->
                        ...
                        <div class="s-header__navbar-row-col">
                            ...
                            <div class="s-header__logo">
                                <a href="index.html" class="s-header__logo-link">
                                    <img class="s-header__logo-img s-header__logo-img-default" src="img/ngalamsecret-removebg-preview.png" alt="ngalamsecret Logo" width="100">
                                    <img class="s-header__logo-img s-header__logo-img-shrink" src="img/ngalamsecret-removebg-preview.png" alt="ngalamsecret Logo" width="100">
                                </a>
                            </div>
                            <!-- End Logo -->
                        </div>
                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider {{ ($title === "Home" ) ? '-is-active' : '' }}" href="/">Home</a></li>
                        ...
                        <!-- Menu List -->                                
                        <ul class="list-unstyled s-header__nav-menu">
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider {{ ($title === "About" ) ? '-is-active' : '' }}" href="/about">About</a></li>
